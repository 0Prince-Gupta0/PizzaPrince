...
export const getAllPizzas = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("https://pizzaprince.onrender.com/api/pizzas/getAllPizzas");
...
export const addPizza = (pizza) => async (dispatch) => {
  ...
  try {
    await axios.post("https://pizzaprince.onrender.com/api/pizzas/addpizza", { pizza });
...
export const getPizzaById = (pizzaId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://pizzaprince.onrender.com/api/pizzas/getpizzabyid", { pizzaId });
...
export const updatePizza = (updatedPizza) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://pizzaprince.onrender.com/api/pizzas/updatepizza", {
      updatedPizza,
    });
...
export const deletePizza = (pizzaId) => async (dispatch) => {
  try {
    await axios.post("https://pizzaprince.onrender.com/api/pizzas/deletepizza", { pizzaId });
...
export const filterPizza = (searchkey, category) => async (dispatch) => {
  ...
  dispatch({ type: "GET_PIZZAS_REQUEST" });
  try {
    const res = await axios.get("https://pizzaprince.onrender.com/api/pizzas/getAllPizzas");
